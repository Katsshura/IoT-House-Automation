...
namespace IoT.House.Automation.Microservices.Arduino.Infra.SqlServer.Repositories
{
    public class ConfigLoaderRepository : IConfigLoaderRepository
    {
        ...
        public object GetConfigValue(string key)
        {
            ...
            var result = _dataAccess.ReadFromProcedure("Arduino", "sp_getconfig", parameters);
